...
import numpy as np
from interface import ContiAgent
...
class Para_update_strategies:
    ...
    def simple_update_parameters(
        ...
        if len(active_agents) >= 2:
            ...
            # with probability β update the state of the agent
            if np.random.rand() < beta:
                ...
                if agent.boundary.contains(
                    ...
                    logging.info("Agent is out of boundary")
